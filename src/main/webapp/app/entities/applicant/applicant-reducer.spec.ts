...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './applicant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLICANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLICANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLICANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLICANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLICANT actions', async () => {
      const expectedActions = [
        {
