...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './quest.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUEST actions', async () => {
      const expectedActions = [
        {
