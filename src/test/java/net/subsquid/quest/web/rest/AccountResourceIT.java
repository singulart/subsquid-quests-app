...
import static net.subsquid.quest.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import net.subsquid.quest.config.Constants;
import net.subsquid.quest.domain.User;
import net.subsquid.quest.repository.AuthorityRepository;
import net.subsquid.quest.repository.UserRepository;
import net.subsquid.quest.security.AuthoritiesConstants;
import net.subsquid.quest.service.UserService;
import net.subsquid.quest.service.dto.AdminUserDTO;
import net.subsquid.quest.service.dto.PasswordChangeDTO;
import net.subsquid.quest.service.dto.UserDTO;
import net.subsquid.quest.web.rest.vm.KeyAndPasswordVM;
import net.subsquid.quest.web.rest.vm.ManagedUserVM;
